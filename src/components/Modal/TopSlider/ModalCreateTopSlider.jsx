...
const ModalCreateTopSlider = ({ open, setOpen, getData }) => {
  const initialValues = {
    title: "",
    status: 1,
    image: "",
    ...
    <Formik
      ...
      onSubmit={async (values, { setSubmitting, resetForm }) => {
        try {
          ...
          setTimeout(() => {
            setSubmitting(false);
            toastSuccess(`Top Slider berhasil dibuat`);
            resetForm();
            getData();
          }, 400);
        } catch (error) {
...
export default ModalCreateTopSlider;
