...
const ElproPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_ELPRO);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog Elpro</h1>
      ...
      <div>
        <KatalogTable
          ...
          urlDelete={ENDPOINTS.DELETE_ELPRO}
        />
      </div>
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_ELPRO}
        title="Elpro"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_ELPRO}
        title="Elpro"
      />
    </div>
  );
