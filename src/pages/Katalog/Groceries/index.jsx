...
const GroceriesPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_GROCERIES);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog Groceries</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_GROCERIES}
      />
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_GROCERIES}
        title="Groceries"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_GROCERIES}
        title="Groceries"
      />
    </div>
  );
