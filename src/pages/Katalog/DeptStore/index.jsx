...
const DeptStorePage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_DEPTSTORE);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog Dept Store</h1>
      ...
      <div>
        <KatalogTable
          ...
          urlDelete={ENDPOINTS.DELETE_DEPTSTORE}
        />
      </div>
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_DEPTSTORE}
        title="Dept Store"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_DEPTSTORE}
        title="Dept Store"
      />
    </div>
  );
