...
const FandBPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_FnB);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog F&B</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_FnB}
      />
