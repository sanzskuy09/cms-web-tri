...
const TranshardwarePage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_TRANSHARDWARE);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">KatalogTranshardware</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_TRANSHARDWARE}
      />
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_TRANSHARDWARE}
        title="Transhardware"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_TRANSHARDWARE}
        title="Transhardware"
      />
    </div>
  );
...
export default TranshardwarePage;
