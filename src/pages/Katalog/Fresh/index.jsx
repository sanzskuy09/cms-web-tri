...
const FreshPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_FRESH);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog Fresh</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_FRESH}
      />
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_FRESH}
        title="Fresh"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_FRESH}
        title="Fresh"
      />
    </div>
  );
