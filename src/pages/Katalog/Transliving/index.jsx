...
const TranslivingPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_TRANSLIVING);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog Transliving</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_TRANSLIVING}
      />
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_TRANSLIVING}
        title="Transliving"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_TRANSLIVING}
        title="Transliving"
      />
    </div>
  );
...
export default TranslivingPage;
