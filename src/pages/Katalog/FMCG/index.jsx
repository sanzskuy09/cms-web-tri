...
const FMCGPage = () => {
  ...
  const fecthData = async () => {
    const res = await API.get(ENDPOINTS.GET_FMCG);
  ...
  return (
    <div className="px-8 py-4 w-full">
      <div className="flex gap-2">
        <h1 className="text-4xl font-bold">Katalog FMCG</h1>
      ...
      <KatalogTable
        ...
        urlDelete={ENDPOINTS.DELETE_FMCG}
      />
      ...
      <ModalCreateKatalog
        ...
        setOpen={setOpen}
        getData={fecthData}
        endpoint={ENDPOINTS.CREATE_FMCG}
        title="FMCG"
      />
      ...
      <ModalUpdateKatalog
        ...
        getData={fecthData}
        data={view}
        endpoint={ENDPOINTS.UPDATE_FMCG}
        title="FMCG"
      />
    </div>
  );
